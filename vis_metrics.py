...
# FOLD_ROOT = "FINETUNE/UBMK/2025-06-30-182523_3_years_b_oct_resnet18_vitL"
# FOLD_ROOT = "FINETUNE/UBMK/2025-06-30-182558_3_years_b_oct_resnet34_vitL"
# FOLD_ROOT = "FINETUNE/UBMK/2025-06-30-185950_3_years_b_oct_resnet50_vitL"
# FOLD_ROOT = "FINETUNE/UBMK/2025-06-30-190001_3_years_b_oct_resnet101_vitL"
# FOLD_ROOT = "FINETUNE/UBMK/2025-06-30-194115_4_years_b_oct_resnet18_vitL"
# FOLD_ROOT = "FINETUNE/UBMK/2025-06-30-194134_4_years_b_oct_resnet34_vitL"
# FOLD_ROOT = "FINETUNE/UBMK/2025-06-30-202303_4_years_b_oct_resnet50_vitL"
# FOLD_ROOT = "FINETUNE/UBMK/2025-06-30-202318_4_years_b_oct_resnet101_vitL"
FOLD_ROOT = "FINETUNE/2025-07-18-004042_kfold_dataset_p_octa_b_oct"
...
for fold_path in fold_dirs:
    ...
    for idx, line in enumerate(lines):
        m = re.match(r"Epoch (\d+)", line)
        if m:
            if epoch_counter == max_idx and in_proba:
                # Yeni epoch başladı, proba bloğunu bitir
                in_proba = False
            epoch_counter = int(m.group(1))
        if epoch_counter == max_idx:
            if line.startswith("True labels:"):
